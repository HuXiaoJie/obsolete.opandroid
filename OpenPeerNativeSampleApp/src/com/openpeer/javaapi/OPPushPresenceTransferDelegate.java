...
public abstract class OPPushPresenceTransferDelegate {
    //-----------------------------------------------------------------------
    ...
    //            thread
    public abstract void onPushPresenceTransferUploadFileDataToURL(
                                                            OPPushPresence session,
                                                            String postURL,
                                                            ...
                                                            OPPushPresenceTransferNotifier notifier
                                                            );
    ...
    //          - this method is called asynchronously on the application's
    //            thread
    public abstract void onPushPresenceTransferDownloadDataFromURL(
                                                            OPPushPresence session,
                                                            String getURL,
