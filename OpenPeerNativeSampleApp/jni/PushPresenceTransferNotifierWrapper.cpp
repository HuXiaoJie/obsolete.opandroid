#include "PushPresenceTransferNotifierWrapper.h"
#include "OpenPeerCoreManager.h"
#include "android/log.h"
#include "globals.h"


//PushPresenceTransferNotifierWrapper implementation
PushPresenceTransferNotifierWrapper::PushPresenceTransferNotifierWrapper(jobject delegate)
{
...
void PushPresenceTransferNotifierWrapper::notifyComplete(bool wasSuccessful)
{
	jclass cls;
	jmethodID method;
	jobject object;
...
PushPresenceTransferNotifierWrapper::~PushPresenceTransferNotifierWrapper()
{
	JNIEnv *jni_env = getEnv();
